...
{
    public class DataIngestion : IClassFixture<DMSTestFixture>
    {
        private readonly DMSTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(DMSTestFixture fixture, ITestOutputHelper output)
        {
