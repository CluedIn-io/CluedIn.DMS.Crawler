...
namespace CluedIn.Crawling.DMS.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IDMSClientFactory>().AsFactory())
                .Register(Component.For<DMSClient>().LifestyleTransient());
